...
class DetectionParams:
    ...
    def __str__(self):
        ...
        str2 = f'DetectionParams(gb_k={self.gb_k}, gb_s={self.gb_s}, at_method=cv.ADAPTIVE_THRESH_GAUSSIAN_C, at_blockSize={self.at_blockSize}, at_C={self.at_C}, median_k={self.median_k}, bw_size={self.bw_size}, vacant_threshold={self.vacant_threshold}, show_imshow={self.show_imshow})'
        return str(str1 + '\n\n' + str2)
