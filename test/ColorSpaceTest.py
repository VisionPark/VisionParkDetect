...
def main():
    ...
    PARAMS_UFPR04 = DetectionParams(
        (3, 3), 0, cv.ADAPTIVE_THRESH_GAUSSIAN_C, 41, 11, 3, 104, vacant_threshold=0.25, show_imshow=True)  # UFPR04

    parking_id = "UFPR04"
    provider_params = ParkingProviderLocalParams(
        parking_id=parking_id, path='E:\\Documents\\PKLot\\PKLot\\PKLot\\PKLot\\'+parking_id, k=50)
